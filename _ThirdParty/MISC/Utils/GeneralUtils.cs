...
public static class GeneralUtils
{
	static void MoveCurrentSelectionToCameraFocus()
	{
		...
		if (obj)
		{
			...
			{
				Debug.Log("GeneralUtils: MoveCurrentSelectionToCameraFocus - no camera selected");
			}
		}
		else
		{
			Debug.Log("GeneralUtils: MoveCurrentSelectionToCameraFocus - no object selected");
		}
	}
	...
	public static void FindCurrentHitPointFromCamera(out Vector3 pos)
	{
		...
		if (Camera.current)
		{
			...
			{
				Debug.Log("Found nothing to hittest against, stuffing object in front of camera");
				pos = Camera.current.transform.position + fwd;			
			}		
		}
		else
		{
			Debug.Log("FindCurrentHitPointFromCamera : Current camera not active!");
		}
	}
	...
	public static void DeleteDirectory(string path, bool recursive)
	{
		...
		{
			Debug.LogWarning("Can not remove directory '" + path + "': " + ex.ToString());
		}
	}
