...
namespace DigitalOpus.MB.Core{
	...
	public class MB3_MeshBakerEditorInternal{
        ...
        private static GUIContent
			...
			lightmappingOptionGUIContent = new GUIContent("Lightmapping UVs","preserve current lightmapping: Use this if all source objects are lightmapped and you want to preserve it. All source objects must use the same lightmap. DOES NOT WORK IN UNITY 5.\n\n"+
            ...
            doBlendShapeGUIContent = new GUIContent("Include Blend Shapes"),
		...
		private SerializedProperty doNorm, doTan, doUV, doUV3, doUV4, doCol, doBlendShapes, clearBuffersAfterBake, uv2OutputParamsPackingMargin, uv2OutputParamsHardAngle;
		...
		public void DrawGUI(SerializedObject meshBaker, MB3_MeshBakerCommon target, System.Type editorWindowType){
            ...
            EditorGUILayout.EndHorizontal();
            EditorGUILayout.PropertyField(doBlendShapes, doBlendShapeGUIContent);
