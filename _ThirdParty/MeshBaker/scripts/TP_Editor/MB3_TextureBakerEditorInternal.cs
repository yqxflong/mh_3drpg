...
namespace DigitalOpus.MB.Core{
	public class MB3_TextureBakerEditorInternal{
		...
		private SerializedProperty logLevel, textureBakeResults, maxTilingBakeSize, maxAtlasSize, doMultiMaterial, fixOutOfBoundsUVs, resultMaterial, resultMaterials, atlasPadding, resizePowerOfTwoTextures, customShaderProperties, objsToMesh, texturePackingAlgorithm, forcePowerOfTwoAtlas, considerNonTextureProperties;
        ...
        public void OnEnable(SerializedObject textureBaker)
        {
            ...
            multipleMaterialBackgroundColor = MakeTex(8, 8, backgroundColor);
            backgroundColor = isPro
                ? new Color32(50, 50, 50, 255)
                : new Color32(160, 160, 160, 255);
            multipleMaterialBackgroundColorDarker = MakeTex(8, 8, backgroundColor);
        ...
        public void OnDisable()
        {
            ...
            {
                GameObject.DestroyImmediate(multipleMaterialBackgroundColor);
            }
        }
