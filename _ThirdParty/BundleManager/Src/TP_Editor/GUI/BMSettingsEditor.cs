...
internal class BMSettingsEditor : Editor 
{
	...
	public override void OnInspectorGUI()
	{
		...
		{
			BuildConfiger.Compress = EditorGUILayout.Toggle("Compress LZ4", BuildConfiger.Compress);
			BuildConfiger.OptimizeTree = EditorGUILayout.Toggle("Optimize Tree", BuildConfiger.OptimizeTree);
			...
			BuildHelper.SetAssetBundleBuildOutput();
