...
public partial class Builder
{
	...
	[MenuItem("Builder/Legacy/Build iPad (TestFlight EBG)")]
	...
	[MenuItem("Builder/Legacy/Build iPad (TestFlight EBG+Kabam)")]
	public static void BuildTestFlightKabam()
	{
		BuildTestFlight(BuildSettings.SuccessEmail);
	}

	[MenuItem("Builder/Legacy/Build Content Packs")]
	public static void BuildContentPacks()
	{
		BuildContentPacksWithOptions(BuildSettings.SuccessEmail,false);
	}
	
	[MenuItem("Builder/Legacy/Build Extended Content Packs")]
	public static void BuildExtendedContentPacks()
	{
		BuildContentPacksWithOptions(BuildSettings.SuccessEmail,true);
	}
	[MenuItem("Builder/Legacy/Build iPad (Submission)")]
