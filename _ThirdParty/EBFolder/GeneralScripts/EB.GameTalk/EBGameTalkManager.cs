...
namespace EB.GameTalk
{
	...
	public class Manager : System.IDisposable
	{
		...
		void OnRPC( string rpcName, ArrayList parameters, System.Action<string,object> callback )
		{
			_deferred.Defer((System.Action)delegate(){
				var handler = (System.Action<ArrayList,System.Action<string,object>>)_rpcs[rpcName];
				if (handler != null)	
				{
		...
		public void Bind( string rpcName, System.Action<ArrayList, System.Action<string,object>> callback )
		{
		...
		public void Bind( string ns, object instance )
		{
			...
			foreach( var method in methods )
			{
				...
				{
					this.Bind(ns+method.Name, delegate(ArrayList obj, System.Action<string, object> obj1) {
