...
namespace EB.IAP.Internal
{
	public class GoogleProvider : MonoBehaviour, Internal.Provider
	{
		...
		void Awake()	
		{
			_class 		= new AndroidJavaClass("org.manhuang.iap.Manager");
		...
		public void PurchaseItem( Item item ) 
		{
			...
			_class.CallStatic("PurchaseItem", item.productId, typeString, item.developerPayload.Replace("{platform}", Name));
		}
		...
		void OnItemPurchaseFailed( string error )
		{
			...
			{
				_config.OnPurchaseFailed(error, null);
			}
		}
