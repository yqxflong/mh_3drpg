...
//			}
	...
	public class FOVTrackInstance : BlendableTrackInstance
	{
		...
		public override void Apply (float blend, EB.Director.Serialization.KeyFrame from, EB.Director.Serialization.KeyFrame to)
		{
			...
			if (_target.GetComponent<Camera>() == null) _target = _target.GetComponentInChildren<Camera>().gameObject;
		...
		public override void SaveState ()
		{
			if ( _target != null)
			{
				...
				_state = _target.GetComponent<Camera>().fieldOfView;
			}
		}
		...
		public override void RestoreState()
		{
			if ( _target != null )
			{
				...
				_target.GetComponent<Camera>().fieldOfView = _state;
			}
		}
	}
	...
	public class OrthographicSizeTrackInstance : BlendableTrackInstance
	{
		...
		public override void Apply (float blend, EB.Director.Serialization.KeyFrame from, EB.Director.Serialization.KeyFrame to)
		{
			if ( _target != null && _target.GetComponent<Camera>() != null )
			{
				var v1 = from.FloatValue;
				var v2 = to.FloatValue;
				var v = Mathf.Lerp(v1,v2,blend);
				_target.GetComponent<Camera>().orthographicSize = v;
			}
		}
		...
		public override void SaveState ()
		{
			if ( _target != null && _target.GetComponent<Camera>() != null )
			{
				_state = _target.GetComponent<Camera>().orthographicSize;
			}
		}
		...
		public override void RestoreState()
		{
			if ( _target != null )
			{
				_target.GetComponent<Camera>().orthographicSize = _state;
			}
		}
	}
	...
	public abstract class ComponentTrackInstance : BlendableTrackInstance
	{
		...
		public override void SaveState ()
		{
			...
			if ( _target != null )
			{
				...
				if ( _component == null )
				{
					_component = (Behaviour)_target.AddComponent(System.Type.GetType(componentName));
					//_component = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(_target, "Assets/Plugins/EB.Director/Runtime/DirectorTracks.cs (659,19)", componentName);
					//_component = (Behaviour)UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(_target, "Assets/Plugins/EB.Director/Runtime/DirectorTracks.cs (659,30)", componentName);
