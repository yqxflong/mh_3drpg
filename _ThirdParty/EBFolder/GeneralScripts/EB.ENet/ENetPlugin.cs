...
// 	   public System.IntPtr           		peer;      /**< peer that generated a connect, disconnect or receive event */
// 	   public byte           		channelID; /**< channel on the peer that generated the event, if appropriate */
// 	   public System.UInt32          		data;      /**< data associated with the event, if appropriate */
// 	   public System.IntPtr         		packet;    /**< packet associated with the event, if appropriate */
		
// 	   public Packet			Packet	{ get { if (packet!=System.IntPtr.Zero) return new Packet(packet); return null; } }
// 	};
	
// 	public class Host : System.IDisposable
// 	{
...
// 		public Host( System.IntPtr handle )
// 		{
// 			Handle = handle;
// 		}
...
// 	public class Peer : System.IDisposable
// 	{
// 		public System.IntPtr Handle { get; private set;}
...
// 		public Peer( System.IntPtr handle )
// 		{
// 			Handle = handle;
...
// 			{
// 				// get the ptr
// 				System.IntPtr ptr  = Marshal.ReadIntPtr(Handle,8);
...
// 		public Packet( System.IntPtr handle )
// 		{
// 			Handle = handle;
// 		}
...
// 		{
// 			// destroy the packet
// 			if (!isSent && Handle != System.IntPtr.Zero)
// 			{
...
// 		[DllImport(DLL_NAME)]
// 		static extern System.IntPtr enet_host_create( [MarshalAs(UnmanagedType.LPStruct)] Address address, uint peerCount, uint channelLimit, uint incomingBandwidth, uint outgoingBandwidth);
		
// 		[DllImport(DLL_NAME)]
// 		static extern int enet_host_service( System.IntPtr host, System.IntPtr netevent, uint timeout );
		
// 		[DllImport(DLL_NAME)]
// 		static extern int enet_address_set_host( System.IntPtr address, [MarshalAs(UnmanagedType.LPStr)] string hostname );
		
// 		[DllImport(DLL_NAME)]
// 		static extern System.IntPtr enet_host_connect( System.IntPtr host, [MarshalAs(UnmanagedType.LPStruct)] Address address, uint channelCount, uint data	);	
		
// 		[DllImport(DLL_NAME)]
// 		static extern int enet_host_compress_with_range_coder( System.IntPtr host);
		
// 		[DllImport(DLL_NAME)]
// 		static extern System.IntPtr enet_packet_create ( byte[] data, int dataLength, uint flags);
		
// 		[DllImport(DLL_NAME)]
// 		static extern void enet_packet_destroy (System.IntPtr packet);
		
// 		[DllImport(DLL_NAME)]
// 		static extern void enet_peer_disconnect_now (System.IntPtr peer, uint data);
		
// 		[DllImport(DLL_NAME)]
// 		static extern void enet_peer_disconnect(System.IntPtr peer, uint data);
		
// 		[DllImport(DLL_NAME)]
// 		static extern int	enet_peer_send (System.IntPtr peer, byte channel, System.IntPtr packet);
		
// 		[DllImport(DLL_NAME)]
// 		static extern void enet_host_destroy(System.IntPtr host);
...
// 		private static System.IntPtr ToPtr<T>( T obj )
// 		{
...
// 		private static void Free( System.IntPtr ptr )
// 		{
...
// 			if (host.Handle == System.IntPtr.Zero)
// 			{
// 				return 0;
// 			}
...
// 		{
// 			if ( peer == null || peer.Handle == System.IntPtr.Zero)
// 			{
// 				return -1;
// 			}
...
// 		{
// 			if (host == null || host.Handle == System.IntPtr.Zero)
// 			{
// 				return;
// 			}
