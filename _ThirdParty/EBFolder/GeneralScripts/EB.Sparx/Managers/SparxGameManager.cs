    ...
    public class GameManager : SubSystem, Updatable
    {
        ...
        public struct LocalCreateGameParams
        {
            ...
            public void AddAIPlayer(Hashtable attributes)
            {
                ...
                var player = Johny.HashtablePool.Claim();
                player["uid"] = Hub.Instance.DataStore.LoginDataStore.LocalUserId;
        ...
        class WalkServers
        {
            private System.Action<string,object>	_onDone;
            private System.Action<WalkServers>  	_onNext;
            ...
            public WalkServers(MasterServer[] servers, System.Action<string, object> onDone, System.Action<WalkServers> onNext)
            {
                _onDone = onDone;
                _onNext = onNext;
                _servers = servers;
        ...
        public override void Connect()
        {
            ...
            var data = Dot.Array("master", Hub.DataStore.LoginDataStore.LoginData, null);
            if (data != null)
            {
        ...
        public void ListGames(MasterServer server, Hashtable attributes, System.Action complete)
        {
