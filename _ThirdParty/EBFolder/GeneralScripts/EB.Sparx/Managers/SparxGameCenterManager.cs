...
namespace EB.Sparx
{
	...
	public class GameCenterManager : SubSystem
	{
        ...
        System.Action<string, string> _leaderboardTitleCallback;
		...
		public void GetAchievementChallengeablePlayers(string achievementName, System.Action<string, string>callback)
		{
		...
		public void GetScoreChallengeablePlayers(int leaderboardId, int playerScore, System.Action<string, string>callback)
		{
		...
		public void GetLeaderboardTitle(int leaderboardId, System.Action<string, string> callback)
		{	
		...
		public void GetActiveChallenges(System.Action<string> callback)
		{
		...
		void ConnectToGameCenter()
		{
			...
			if (localUser != null)
			{
				...
				else if (!_isAuthenticating)
				{
					...
					localUser.Authenticate(OnAuthenticate);
				}
			}
		}
        ...
        void OnAuthenticate(bool success)
		{
			...
			{
                //TODO_LOGIN:Ðè¸øGameCenterId¸³Öµ
                //var localUser = Hub.LoginManager.LocalUser;
                //if ( localUser != null )
                {
                    var gcid = GameCenterId;//localUser.GameCenterId;
                    if ( gcid != Social.localUser.id)
					{
