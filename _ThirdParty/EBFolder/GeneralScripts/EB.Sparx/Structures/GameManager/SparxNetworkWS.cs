...
namespace EB.Sparx
{
	...
	public class NetworkWS : Network
	{
		...
		void OnSocketConnect()
		{
			...
			_deferred.Defer( (System.Action)this.DispatchConnect); 
		}
		...
		void OnSocketReceive( byte[] data )
		{
			try 
			{
				...
				_deferred.Defer( (System.Action<uint,Packet>)this.DispatchReceive, playerId, packet );
			}
			catch (System.Exception e )
			{
				_deferred.Defer( (System.Action<string>)DispatchError, "error occured decoding packet : " + e.ToString() ); 
			}
		}
