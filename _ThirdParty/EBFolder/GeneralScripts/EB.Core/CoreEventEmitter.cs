...
namespace EB
{
	...
	public class EventEmitter : System.IDisposable
	{
		...
		private Hashtable _events = Johny.HashtablePool.Claim();
		...
		public Handle On( string name, System.Action callback )
		{
			return Add( name, callback );
		}
		
		public Handle On<Arg1>( string name, System.Action<Arg1> callback )
		{
			return Add( name, callback );
		}
		
		public Handle On<Arg1, Arg2>( string name, System.Action<Arg1,Arg2> callback )
		{
			return Add( name, callback );
		}
		
		public Handle On<Arg1, Arg2, Arg3>( string name, System.Action<Arg1,Arg2, Arg3> callback )
		{
			return Add( name, callback );
		}
		
		public Handle Once( string name, System.Action callback )
		{
			Handle h = default(Handle);
			h = Add( name, (System.Action)delegate(){
				h.Clear();
				callback();
			});
			return h;
		...
		public Handle Once<Arg1>( string name, System.Action<Arg1> callback )
		{
			Handle h = default(Handle);
			h = Add( name, (System.Action<Arg1>)delegate(Arg1 arg1){
				h.Clear();
				callback(arg1);
			});
			return h;
		...
		public Handle Once<Arg1, Arg2>( string name, System.Action<Arg1,Arg2> callback )
		{
			Handle h = default(Handle);
			h = Add( name, (System.Action<Arg1,Arg2>)delegate(Arg1 arg1, Arg2 arg2){
				h.Clear();
				callback(arg1, arg2);
			});
			return h;
		...
		public Handle Once<Arg1, Arg2, Arg3>( string name, System.Action<Arg1,Arg2, Arg3> callback )
		{
			Handle h = default(Handle);
			h = Add( name, (System.Action<Arg1,Arg2, Arg3>)delegate(Arg1 arg1, Arg2 arg2, Arg3 arg3){
				h.Clear();
