...
namespace EB
{
	namespace IO
	{
		...
		{
			public static char[] kPathCombineTrimChars = new char[]{ System.IO.Path.DirectorySeparatorChar, System.IO.Path.AltDirectorySeparatorChar, System.IO.Path.VolumeSeparatorChar };
			
			public static string Combine (string path1, string path2)
			{
				if( string.IsNullOrEmpty( path2 ) == false )
				{
					path2 = path2.TrimStart( kPathCombineTrimChars );
				}
	...
	public static class Util
	{
		...
		public static void RecursiveOp(GameObject obj, System.Func<bool,GameObject> fnObj)
		{
        ...
        /// <returns></returns>
		public static bool IsJson(string inputStr)
		{
