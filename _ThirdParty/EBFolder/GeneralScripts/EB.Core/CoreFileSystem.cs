...
namespace EB
{
	...
	public static class FileSystem
	{
		...
		public static decimal GetAvailableSpaceInBytes(string PathOnDrive)
		{
			...
			throw new System.Exception("EB.FileSystem.GetAvailableSpaceInBytes android drive not found");
...
#else
			throw new System.Exception("EB.FileSystem.GetDrives not implemented yet");
#endif
		}
	}	
}
