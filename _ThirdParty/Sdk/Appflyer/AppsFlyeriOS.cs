...
namespace AppsFlyerSDK
{
    public class AppsFlyeriOS
    {
        ...
        {
                startSDK(false, Appsflyer.AppsflyManager.CallBackObjectName);
        }
        ...
        {
                sendEvent(eventName, eventValues, false, Appsflyer.AppsflyManager.CallBackObjectName);
        }
        ...
        /// Enables you to cross-reference your own unique ID with Appsflyer.AppsflyManager’s unique ID and the other devices’ IDs.
        /// </summary>
        ...
        /// see [Setting additional custom data] (https://support.appsflyer.com/hc/en-us/articles/207032066-Appsflyer.AppsflyManager-SDK-Integration-iOS#setting-additional-custom-data) for more information.
        /// </summary>
        ...
        /// <summary>
        ///  Use this method to set your Appsflyer.AppsflyManager's dev key.
        /// </summary>
        /// <param name="appsFlyerDevKey">Appsflyer.AppsflyManager's Dev-Key, which is accessible from your Appsflyer.AppsflyManager account under 'App Settings' in the dashboard.</param>
        ...
        /// <summary>
        ///  Appsflyer.AppsflyManager SDK collect Apple's `advertisingIdentifier` if the `AdSupport.framework` included in the SDK.
        ...
        /// <summary>
        /// Enables Debug logs for the Appsflyer.AppsflyManager SDK.
        ...
        /// </summary>
        /// <param name="appInviteOneLinkID">OneLink ID obtained from the Appsflyer.AppsflyManager Dashboard.</param>
        ...
        public static void setUserEmails(Appsflyer.EmailCryptType cryptType, int length, params string[] userEmails)
        {
#if !UNITY_EDITOR
        ...
        /// <summary>
        /// Get Appsflyer.AppsflyManager's unique device ID, which is created for every new install of an app.
        /// </summary>
        ...
        /// <summary>
        /// Register uninstall - you should register for remote notification and provide Appsflyer.AppsflyManager the push device token.
        /// </summary>
        ...
        /// <summary>
        /// Enable Appsflyer.AppsflyManager to handle a push notification.
        /// </summary>
        ...
        /// Make sure to use the promoted App ID as it appears within the Appsflyer.AppsflyManager dashboard.
        /// </summary>
        ...
        /*
         * Appsflyer.AppsflyManager ios method mapping
         */
        ...
        [DllImport("__Internal")]
        private static extern void _setUserEmails(Appsflyer.EmailCryptType cryptType, int length, params string[] userEmails);
