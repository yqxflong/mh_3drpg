...
namespace Appsflyer
{
    public class AppsflyManager
    {
        ...
        public static void SendGuideData(string guideid)
        {
            sendEvent(AFInAppEvents.TUTORIAL_COMPLETION, new Dictionary<string, string>() { { AFInAppEvents.CONTENT_ID, guideid } });
        }
    }
