...
namespace Umeng
{
    ...
    public partial class Analytics
    {
        ...
        //Debug.Log("Event");  
#elif UNITY_IPHONE && USE_UMENG
        UmSDKEventWithLabel(eventId, label);
#elif UNITY_ANDROID
        ...
        public static void Event(string eventId, Dictionary<string, string> attributes)
        {
            ...
            //Debug.Log("Event");        
#elif UNITY_IPHONE && USE_UMENG
			UmSDKEventWithAttributes(eventId, DictionaryToJson(attributes));
#elif UNITY_ANDROID
        ...
        /// <param name="eventId">友盟后台设定的事件Id</param>
        /// <param name="attributes"> 属性中的Key-Vaule Pair不能超过10个</param>
        public static void Event(string eventId, Dictionary<string, object> attributes)
        {
#if UNITY_EDITOR
            //Debug.Log("Event");        
#elif UNITY_IPHONE && USE_UMENG
			UmSDKEventWithAttributes(eventId, ToJsonStr(attributes));
#elif UNITY_ANDROID
            Agent.CallStatic("onEvent", Context, eventId, ToJavaHashMap(attributes));
#endif
        ...
        public static void PageBegin(string pageName)
        {
		    ...
		    //Debug.Log("PageBegin");
#elif UNITY_IPHONE && USE_UMENG
            UmSDKBeginLogPageView(pageName);
#elif UNITY_ANDROID
		...
		public static string GetTestDeviceInfo()
		{
			...
			return null;
#elif UNITY_IPHONE && USE_UMENG
			return UmSDKGetDeviceID();
#elif UNITY_ANDROID

           EB.Debug.Log("GetDeviceInfo return ");
...
#else
        UmSDKLogPageViewWithSeconds(pageName, seconds);
#endif
    }
...
#region Wrapper
...
#if UNITY_IPHONE && USE_UMENG && !UNITY_EDITOR
	    ...
	    public static extern void UmSDKSetWrapperTypeAndVersion(string wrapperType,string wrapperVersion);
		    
		[DllImport("__Internal")]
		public static extern void UmSDKSetLogEnabled(bool value);
	    
	    [DllImport("__Internal")]
	    public static extern void UmSDKSetScenarioType();
	    
	    [DllImport("__Internal")]
	    public static extern void UmSDKUMCommonSetAppkeyAndChannel(string appkey, string channelId);
    ...
    [DllImport("__Internal")]
    public static extern void UmSDKEvent(string eventId);



    [DllImport("__Internal")]
    public static extern void UmSDKEventWithLabel(string eventId, string label);



    [DllImport("__Internal")]
    public static extern void UmSDKEventWithAttributes(string eventId, string jsonstring);
    ...
    [DllImport("__Internal")]
    public static extern void UmSDKLogPageViewWithSeconds(string pageName, int seconds);

    [DllImport("__Internal")]
    public static extern void UmSDKBeginLogPageView(string pageName);

    [DllImport("__Internal")]
    public static extern void UmSDKEndLogPageView(string pageName);

    [DllImport("__Internal")]
    public static extern bool UmSDKIsJailBroken();
	
    [DllImport("__Internal")]
    public static extern bool UmSDKIsPirated();
	

	[DllImport("__Internal")]
	public static extern string UmSDKGetDeviceID();


		
	[DllImport("__Internal")]
	public static extern  void UmSDKSetEncryptEnabled(bool value);
