...
namespace com.amazon.device.iap.cpt
{
    public sealed class RequestOutput : Jsonable
    {
        ...
        {
            Dictionary<string, RequestOutput> result = new Dictionary<string, RequestOutput>();
            foreach (var entry in jsonMap)
            {
                RequestOutput value = CreateFromDictionary(entry.Value as Dictionary<string, object>);
        ...
        {
            List<RequestOutput> result = new List<RequestOutput>();
