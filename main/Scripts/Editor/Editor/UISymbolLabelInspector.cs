...
[CustomEditor(typeof(UISymbolLabel), true)]
public class UISymbolLabelInspector : UIWidgetInspector
{
	...
	{
		serializedObject.Update();
		SerializedProperty sp = serializedObject.FindProperty("mSymbolAtlas");
		sp.objectReferenceValue = obj;
		serializedObject.ApplyModifiedProperties();
