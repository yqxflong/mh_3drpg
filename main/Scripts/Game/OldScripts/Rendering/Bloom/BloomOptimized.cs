...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class BloomOptimized : PostEffectsBase
    {
        ...
        private bool mBloomEnable = true;
        /*private void OnGUI()
        {
            GUILayout.BeginHorizontal();

            if (GUILayout.Button("close bloom"))
            {
                mBloomEnable = false;
            }

            if (GUILayout.Button("open bloom"))
            {
                mBloomEnable = true;
            }
        ...
        void OnEnable()
        {
            if (!mBloomEnable || CheckResources() == false)
            {
                this.enabled = false;
            }
        }
        ...
        void OnRenderImage (RenderTexture source, RenderTexture destination)
		{
            ...
            int divider = resolution == Resolution.Low ? 2 : 1;
