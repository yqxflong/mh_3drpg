...
Shader "Custom/Scaler/Particles/Scroll2LayersSineAlphaBlended" {
Properties {
...
//		uniform int	bMirror;
	...
	VertexOutput vert (appdata_full v)
	{
		...
		// if(IsBindBone)
		// {
		// 	wpos.z =   2*MirrorPosX - wpos.z;
		// }
		// else
		// {
		// 	wpos.x =   2*MirrorPosX - wpos.x;
		// }			
		// o.pos = mul(UNITY_MATRIX_VP, wpos);
		// #endif

		// #if defined (MIRROR_BB)
