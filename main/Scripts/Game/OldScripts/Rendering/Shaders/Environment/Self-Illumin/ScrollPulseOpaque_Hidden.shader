...
Shader "Hidden/Enviro/Self-Illumin/ScrollPulseOpaque"
{
	Properties 
	{
		...
		SubShader 
		{
			...
			Pass
			{
				...
				{   
					...
					data.color = _Color * lerp(_MinPulseColor, _MaxPulseColor, cos(_Pulse * _Time.y * 3.14159) * 0.5 + 0.5) * _EBGEnvAdjustScale;
					return data;
				}
