...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Unity_Jobs_JobHandle_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ScheduleBatchedJobs_1);
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref Unity.Jobs.JobHandle instance_of_this_method)
        {
        ...
        static StackObject* ScheduleBatchedJobs_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
