...
{
    unsafe class System_Collections_Generic_List_1_Item_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<EB.IAP.Item>);
            args = new Type[]{typeof(System.Comparison<EB.IAP.Item>)};
            ...
            args = new Type[]{typeof(EB.IAP.Item)};
        ...
        static StackObject* Sort_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Comparison<EB.IAP.Item> @comparison = (System.Comparison<EB.IAP.Item>)typeof(System.Comparison<EB.IAP.Item>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            System.Collections.Generic.List<EB.IAP.Item> instance_of_this_method = (System.Collections.Generic.List<EB.IAP.Item>)typeof(System.Collections.Generic.List<EB.IAP.Item>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<EB.IAP.Item>();
