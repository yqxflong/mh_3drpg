...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FlatBuffers_FlatBufferBuilder_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, AddOffset_1);
            ...
            app.RegisterCLRMethodRedirection(method, AddBool_2);
            args = new Type[]{typeof(System.Int32), typeof(System.Int32), typeof(System.Int32)};
            method = type.GetMethod("AddInt", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, AddInt_3);
            args = new Type[]{};
            method = type.GetMethod("EndObject", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, EndObject_4);
            args = new Type[]{typeof(System.Int32), typeof(System.Int32), typeof(System.Int32)};
            method = type.GetMethod("StartVector", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, StartVector_5);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("AddOffset", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, AddOffset_6);
            args = new Type[]{};
            method = type.GetMethod("EndVector", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, EndVector_7);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("Finish", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Finish_8);
            ...
            app.RegisterCLRMethodRedirection(method, AddFloat_9);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("AddInt", flag, null, args, null);
        ...
        static StackObject* AddOffset_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* AddBool_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 4);
        ...
        static StackObject* AddInt_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 4);
        ...
        static StackObject* EndObject_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* StartVector_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 4);
        ...
        static StackObject* AddOffset_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* Finish_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* AddFloat_9(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 4);
