...
{
    unsafe class FlatBuffers_StringOffset_Binding
    {
        ...
        static void WriteBackInstance(ILRuntime.Runtime.Enviorment.AppDomain __domain, StackObject* ptr_of_this_method, IList<object> __mStack, ref FlatBuffers.StringOffset instance_of_this_method)
        {
            ...
            switch(ptr_of_this_method->ObjectType)
            {
                ...
                case ObjectTypes.StaticFieldReference:
                 ...
                 case ObjectTypes.ArrayReference:
                    {
                        var instance_of_arrayReference = __mStack[ptr_of_this_method->Value] as FlatBuffers.StringOffset[];
        ...
        {
            FlatBuffers.StringOffset ins =(FlatBuffers.StringOffset)o;
