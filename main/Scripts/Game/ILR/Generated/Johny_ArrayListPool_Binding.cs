...
{
    unsafe class Johny_ArrayListPool_Binding
    {
        ...
        static StackObject* Claim_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Johny.ArrayListPool.Claim(@capacity);
        ...
        static StackObject* Release_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.ArrayList @ht = (System.Collections.ArrayList)typeof(System.Collections.ArrayList).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            Johny.ArrayListPool.Release(@ht);
