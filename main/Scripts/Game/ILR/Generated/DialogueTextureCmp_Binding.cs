...
{
    unsafe class DialogueTextureCmp_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::DialogueTextureCmp);
        ...
        static StackObject* set_spriteName_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::DialogueTextureCmp instance_of_this_method = (global::DialogueTextureCmp)typeof(global::DialogueTextureCmp).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
