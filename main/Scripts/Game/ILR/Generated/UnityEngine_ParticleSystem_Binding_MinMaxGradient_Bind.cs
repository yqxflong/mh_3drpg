...
{
    unsafe class UnityEngine_ParticleSystem_Binding_MinMaxGradient_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.ParticleSystem.MinMaxGradient);

            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.ParticleSystem.MinMaxGradient());
