...
{
    unsafe class EB_Sparx_LevelRewardsStatus_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(EB.Sparx.LevelRewardsStatus);
            args = new Type[]{};
        ...
        static StackObject* get_Level_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            EB.Sparx.LevelRewardsStatus instance_of_this_method = (EB.Sparx.LevelRewardsStatus)typeof(EB.Sparx.LevelRewardsStatus).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
