...
{
    unsafe class Johny_Action_ActionCellStampDown_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Johny.Action.ActionCellStampDown);
            args = new Type[]{typeof(Johny.Action.ActionCellStampDown.FinishStatus)};
        ...
        static StackObject* Stop_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Johny.Action.ActionCellStampDown.FinishStatus @status = (Johny.Action.ActionCellStampDown.FinishStatus)typeof(Johny.Action.ActionCellStampDown.FinishStatus).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            Johny.Action.ActionCellStampDown instance_of_this_method = (Johny.Action.ActionCellStampDown)typeof(Johny.Action.ActionCellStampDown).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Johny.Action.ActionCellStampDown(@delay, @during, @cell, @from, @to);
