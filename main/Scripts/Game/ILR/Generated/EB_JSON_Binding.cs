...
namespace ILRuntime.Runtime.Generated
{
    unsafe class EB_JSON_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(EB.JSON);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Parse", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Parse_0);
            args = new Type[]{typeof(System.Object)};
            method = type.GetMethod("Stringify", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Stringify_1);
        ...
        static StackObject* Parse_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = EB.JSON.Parse(@json);
        ...
        static StackObject* Stringify_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = EB.JSON.Stringify(@obj);
