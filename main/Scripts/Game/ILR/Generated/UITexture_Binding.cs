...
{
    unsafe class UITexture_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::UITexture);
            args = new Type[]{typeof(UnityEngine.Texture)};
            method = type.GetMethod("SetTexture", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetTexture_0);
            args = new Type[]{typeof(UnityEngine.Rect)};
            method = type.GetMethod("set_uvRect", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_uvRect_1);


        }


        static StackObject* SetTexture_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            instance_of_this_method.SetTexture(@value);
