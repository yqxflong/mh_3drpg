...
{
    unsafe class System_Collections_Generic_List_1_Authenticator_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<EB.Sparx.Authenticator>);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(EB.Sparx.Authenticator)};
        ...
        static StackObject* ToArray_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<EB.Sparx.Authenticator> instance_of_this_method = (System.Collections.Generic.List<EB.Sparx.Authenticator>)typeof(System.Collections.Generic.List<EB.Sparx.Authenticator>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* Add_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            EB.Sparx.Authenticator @item = (EB.Sparx.Authenticator)typeof(EB.Sparx.Authenticator).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<EB.Sparx.Authenticator>();
