...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Collections_Generic_Queue_1_GameObject_Binding
    {
        ...
        static StackObject* Enqueue_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Queue<UnityEngine.GameObject> instance_of_this_method = (System.Collections.Generic.Queue<UnityEngine.GameObject>)typeof(System.Collections.Generic.Queue<UnityEngine.GameObject>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
