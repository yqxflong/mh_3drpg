...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UILabel_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::UILabel);
            args = new Type[]{};
            ...
            method = type.GetMethod("set_gradientTop", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_gradientTop_2);
            args = new Type[]{typeof(UnityEngine.Color)};
            method = type.GetMethod("set_gradientBottom", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_gradientBottom_3);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_applyGradient", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_applyGradient_4);
            args = new Type[]{};
            method = type.GetMethod("get_fontSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_fontSize_5);
            args = new Type[]{typeof(UnityEngine.Color)};
            method = type.GetMethod("set_effectColor", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_effectColor_6);
        ...
        static StackObject* set_gradientBottom_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            instance_of_this_method.gradientBottom = value;

            return __ret;
        }

        static StackObject* set_applyGradient_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            instance_of_this_method.applyGradient = value;
        ...
        static StackObject* set_effectColor_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
