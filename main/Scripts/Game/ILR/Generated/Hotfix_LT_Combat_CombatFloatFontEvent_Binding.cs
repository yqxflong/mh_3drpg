...
{
    unsafe class Hotfix_LT_Combat_CombatFloatFontEvent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Hotfix_LT.Combat.CombatFloatFontEvent);
            args = new Type[]{};
        ...
        static StackObject* get_Target_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Hotfix_LT.Combat.CombatFloatFontEvent instance_of_this_method = (Hotfix_LT.Combat.CombatFloatFontEvent)typeof(Hotfix_LT.Combat.CombatFloatFontEvent).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
