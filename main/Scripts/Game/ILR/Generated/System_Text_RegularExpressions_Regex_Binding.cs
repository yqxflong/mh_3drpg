...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Text_RegularExpressions_Regex_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, IsMatch_1);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("Match", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Match_2);
        ...
        static StackObject* IsMatch_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 3);
        ...
        static StackObject* Match_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
