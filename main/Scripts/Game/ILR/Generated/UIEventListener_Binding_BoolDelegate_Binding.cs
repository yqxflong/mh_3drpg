...
{
    unsafe class UIEventListener_Binding_BoolDelegate_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::UIEventListener.BoolDelegate);
        ...
        static StackObject* Invoke_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::UIEventListener.BoolDelegate instance_of_this_method = (global::UIEventListener.BoolDelegate)typeof(global::UIEventListener.BoolDelegate).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.Invoke(@go, @state);
