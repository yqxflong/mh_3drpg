...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_Decimal_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("Divide", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Divide_1);
        ...
        static StackObject* Divide_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = System.Decimal.Divide(@d1, @d2);
