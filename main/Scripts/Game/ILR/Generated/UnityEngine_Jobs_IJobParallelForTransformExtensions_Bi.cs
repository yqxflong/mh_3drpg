...
{
    unsafe class UnityEngine_Jobs_IJobParallelForTransformExtensions_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.Jobs.IJobParallelForTransformExtensions);
            ...
            args = new Type[]{typeof(global::JobUpdateSetHealthBar)};
            if (genericMethods.TryGetValue("Schedule", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(Unity.Jobs.JobHandle), typeof(global::JobUpdateSetHealthBar), typeof(UnityEngine.Jobs.TransformAccessArray), typeof(Unity.Jobs.JobHandle)))
                    {
                        method = m.MakeGenericMethod(args);
                        app.RegisterCLRMethodRedirection(method, Schedule_0);
