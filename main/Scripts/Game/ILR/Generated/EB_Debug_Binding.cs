...
namespace ILRuntime.Runtime.Generated
{
    unsafe class EB_Debug_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{typeof(System.Object), typeof(System.Object[])};
            method = type.GetMethod("LogUI", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, LogUI_3);
            args = new Type[]{typeof(System.Object), typeof(System.Object[])};
            method = type.GetMethod("LogUIStatistics", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, LogUIStatistics_4);
        ...
        static StackObject* LogError_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            EB.Debug.LogError(@message, @args);
        ...
        static StackObject* LogWarning_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            EB.Debug.LogWarning(@message, @args);

            return __ret;
        }

        static StackObject* LogUI_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            EB.Debug.LogUI(@message, @args);

            return __ret;
        }

        static StackObject* LogUIStatistics_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            EB.Debug.LogUIStatistics(@message, @args);
