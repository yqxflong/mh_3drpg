...
namespace ILRuntime.Runtime.Generated
{
    unsafe class EB_Sparx_BaseSDKManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, GetAppid_0);
            args = new Type[]{typeof(System.Int32)};
            method = type.GetMethod("SetCurHCCount", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetCurHCCount_1);
            args = new Type[]{typeof(EB.Sparx.RoleData)};
            method = type.GetMethod("SetRoleData", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetRoleData_2);


        }


        static StackObject* GetAppid_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* SetCurHCCount_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* SetRoleData_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
