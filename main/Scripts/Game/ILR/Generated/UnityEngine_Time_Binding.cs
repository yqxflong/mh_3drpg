...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Time_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, get_time_1);
            args = new Type[]{};
            method = type.GetMethod("get_unscaledTime", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_unscaledTime_2);
            args = new Type[]{};
            method = type.GetMethod("get_realtimeSinceStartup", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_realtimeSinceStartup_3);
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("set_timeScale", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_timeScale_4);
            args = new Type[]{};
            method = type.GetMethod("get_timeScale", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_timeScale_5);
            args = new Type[]{};
            ...
            app.RegisterCLRMethodRedirection(method, get_frameCount_7);
        ...
        static StackObject* get_time_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
        ...
        static StackObject* get_unscaledTime_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
        ...
        static StackObject* get_realtimeSinceStartup_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
        ...
        static StackObject* set_timeScale_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* get_timeScale_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
        ...
        static StackObject* get_frameCount_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
