...
{
    unsafe class EB_Sparx_SparxAPI_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(EB.Sparx.SparxAPI);
        ...
        static StackObject* Post_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            EB.Sparx.SparxAPI instance_of_this_method = (EB.Sparx.SparxAPI)typeof(EB.Sparx.SparxAPI).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
