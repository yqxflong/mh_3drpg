...
{
    unsafe class GM_AssetLoader_1_GameObject_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(GM.AssetLoader<UnityEngine.GameObject>);
            args = new Type[]{};
        ...
        static StackObject* get_Success_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
