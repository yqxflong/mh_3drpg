...
{
    unsafe class EventDelegate_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::EventDelegate);
            ...
            args = new Type[]{typeof(System.Collections.Generic.List<global::EventDelegate>), typeof(global::EventDelegate.Callback)};
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new global::EventDelegate[s]);

            args = new Type[]{typeof(global::EventDelegate.Callback)};
            method = type.GetConstructor(flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Ctor_0);
            args = new Type[]{typeof(UnityEngine.MonoBehaviour), typeof(System.String)};
            method = type.GetConstructor(flag, null, args, null);
        ...
        static StackObject* Execute_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.List<global::EventDelegate> @list = (System.Collections.Generic.List<global::EventDelegate>)typeof(System.Collections.Generic.List<global::EventDelegate>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            global::EventDelegate.Execute(@list);
        ...
        static StackObject* Add_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            global::EventDelegate.Callback @callback = (global::EventDelegate.Callback)typeof(global::EventDelegate.Callback).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            var result_of_this_method = global::EventDelegate.Add(@list, @callback);
