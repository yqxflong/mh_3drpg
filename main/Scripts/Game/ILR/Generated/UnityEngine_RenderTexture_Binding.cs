...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_RenderTexture_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_depth_0);
            ...
            app.RegisterCLRMethodRedirection(method, set_useMipMap_2);
            args = new Type[]{typeof(System.Boolean)};
            method = type.GetMethod("set_autoGenerateMips", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_autoGenerateMips_3);
            args = new Type[]{};
        ...
        static StackObject* set_depth_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* ReleaseTemporary_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            UnityEngine.RenderTexture @temp = (UnityEngine.RenderTexture)typeof(UnityEngine.RenderTexture).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* set_autoGenerateMips_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
