...
{
    unsafe class EB_Sparx_SubSystem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(EB.Sparx.SubSystem);
            args = new Type[]{};
        ...
        static StackObject* Connect_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            EB.Sparx.SubSystem instance_of_this_method = (EB.Sparx.SubSystem)typeof(EB.Sparx.SubSystem).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
