...
{
    unsafe class EB_Collections_Queue_1_Transform_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(EB.Collections.Queue<UnityEngine.Transform>);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new EB.Collections.Queue<UnityEngine.Transform>(@capacity);
