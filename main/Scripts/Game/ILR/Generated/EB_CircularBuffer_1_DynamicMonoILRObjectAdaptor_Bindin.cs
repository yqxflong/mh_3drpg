...
{
    unsafe class EB_CircularBuffer_1_DynamicMonoILRObjectAdaptor_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(EB.CircularBuffer<global::DynamicMonoILRObjectAdaptor.Adaptor>);
            args = new Type[]{};
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new EB.CircularBuffer<global::DynamicMonoILRObjectAdaptor.Adaptor>(@size);
