...
{
    unsafe class System_Action_2_Item_Transaction_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Action<EB.IAP.Item, EB.IAP.Transaction>);
            args = new Type[]{typeof(EB.IAP.Item), typeof(EB.IAP.Transaction)};
