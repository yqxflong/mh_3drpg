...
{
    unsafe class DebugSystem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::DebugSystem);
            ...
            args = new Type[]{typeof(System.Object), typeof(UnityEngine.LogType)};
            method = type.GetMethod("Log", flag, null, args, null);
        ...
        static StackObject* Log_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.String @systemName = (System.String)typeof(System.String).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            global::DebugSystem.Log(@message, @systemName, @importance);
