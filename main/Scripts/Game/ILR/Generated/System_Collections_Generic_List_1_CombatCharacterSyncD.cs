...
{
    unsafe class System_Collections_Generic_List_1_CombatCharacterSyncData_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<Hotfix_LT.Combat.CombatCharacterSyncData>);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(Hotfix_LT.Combat.CombatCharacterSyncData)};
            method = type.GetMethod("Add", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Add_2);
            args = new Type[]{typeof(System.Collections.Generic.IComparer<Hotfix_LT.Combat.CombatCharacterSyncData>)};
            method = type.GetMethod("Sort", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Sort_3);
            args = new Type[]{typeof(System.Predicate<Hotfix_LT.Combat.CombatCharacterSyncData>)};
        ...
        static StackObject* Find_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Predicate<Hotfix_LT.Combat.CombatCharacterSyncData> @match = (System.Predicate<Hotfix_LT.Combat.CombatCharacterSyncData>)typeof(System.Predicate<Hotfix_LT.Combat.CombatCharacterSyncData>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new System.Collections.Generic.List<Hotfix_LT.Combat.CombatCharacterSyncData>();
