...
{
    unsafe class System_Collections_Generic_List_1_User_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.List<EB.Sparx.User>);
            ...
            args = new Type[]{typeof(System.Collections.Generic.IEnumerable<EB.Sparx.User>)};
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            System.Collections.Generic.IEnumerable<EB.Sparx.User> @collection = (System.Collections.Generic.IEnumerable<EB.Sparx.User>)typeof(System.Collections.Generic.IEnumerable<EB.Sparx.User>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);


            var result_of_this_method = new System.Collections.Generic.List<EB.Sparx.User>(@collection);
