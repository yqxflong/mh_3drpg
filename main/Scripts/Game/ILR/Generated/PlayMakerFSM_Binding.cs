...
{
    unsafe class PlayMakerFSM_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::PlayMakerFSM);
            args = new Type[]{};
            method = type.GetMethod("get_Fsm", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Fsm_0);
            args = new Type[]{};
            method = type.GetMethod("Reset", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, Reset_1);
            args = new Type[]{typeof(global::FsmTemplate)};
            method = type.GetMethod("SetFsmTemplate", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetFsmTemplate_2);
        ...
        static StackObject* SetFsmTemplate_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            global::FsmTemplate @template = (global::FsmTemplate)typeof(global::FsmTemplate).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
            ...
            instance_of_this_method.SetFsmTemplate(@template);
