...
{
    unsafe class System_Action_1_CombatHitDamageEvent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Action<Hotfix_LT.Combat.CombatHitDamageEvent>);
            args = new Type[]{typeof(Hotfix_LT.Combat.CombatHitDamageEvent)};
