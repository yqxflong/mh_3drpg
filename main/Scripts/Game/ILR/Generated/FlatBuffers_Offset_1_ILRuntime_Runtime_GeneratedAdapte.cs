...
{
    unsafe class FlatBuffers_Offset_1_ILRuntime_Runtime_GeneratedAdapter_TableAdapter_Binding_Adapter_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(FlatBuffers.Offset<ILRuntime.Runtime.GeneratedAdapter.TableAdapter.Adapter>);
            ...
            app.RegisterCLRCreateDefaultInstance(type, () => new FlatBuffers.Offset<ILRuntime.Runtime.GeneratedAdapter.TableAdapter.Adapter>());
        ...
        {
            return ((FlatBuffers.Offset<ILRuntime.Runtime.GeneratedAdapter.TableAdapter.Adapter>)o).Value;
        }

        static StackObject* CopyToStack_Value_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((FlatBuffers.Offset<ILRuntime.Runtime.GeneratedAdapter.TableAdapter.Adapter>)o).Value;
