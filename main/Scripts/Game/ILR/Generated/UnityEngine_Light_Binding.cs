...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Light_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_intensity_0);
        ...
        static StackObject* set_intensity_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.Light instance_of_this_method = (UnityEngine.Light)typeof(UnityEngine.Light).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
