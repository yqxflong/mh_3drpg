...
{
    unsafe class UnityEngine_ParticleSystem_Binding_MinMaxCurve_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(UnityEngine.ParticleSystem.MinMaxCurve);
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("op_Implicit", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, op_Implicit_0);

            app.RegisterCLRCreateDefaultInstance(type, () => new UnityEngine.ParticleSystem.MinMaxCurve());
        ...
        static StackObject* op_Implicit_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Single @constant = *(float*)&ptr_of_this_method->Value;


            var result_of_this_method = (UnityEngine.ParticleSystem.MinMaxCurve)constant;
