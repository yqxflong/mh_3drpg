...
namespace ILRuntime.Runtime.Generated
{
    unsafe class GameFlowControlManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            args = new Type[]{};
            method = type.GetMethod("get_ActiveStateName", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_ActiveStateName_3);
        ...
        static StackObject* get_ActiveStateName_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = instance_of_this_method.ActiveStateName;
