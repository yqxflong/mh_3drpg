		...
		public virtual void ErodeWalkableArea (int xmin, int zmin, int xmax, int zmax) {
			...
			if (!erosionUseTags) {
				...
				if (erodeIterations+erosionFirstTag > 31) {
					EB.Debug.LogError("Too few tags available for {0} erode iterations and starting with tag {1} (erodeIterations+erosionFirstTag > 31)" , erodeIterations, erosionFirstTag );
					return;
				}
