...
namespace Pathfinding.Serialization {
	public class UnityObjectConverter : JsonConverter {
		...
		public override object ReadJson (Type objectType, Dictionary<string, object> values) {
			...
			if (System.Type.Equals(type, null)) {
				EB.Debug.LogError("Could not find type '{0}'. Cannot deserialize Unity reference" ,typename);
				return null;
			}
		...
		public override Dictionary<string, object> WriteJson (Type type, object value) {
			...
			if (component != null || go != null) {
				...
				if (helper == null) {
					EB.Debug.Log("Adding UnityReferenceHelper to Unity Reference '{0}'",obj.name);
	...
	public class MatrixConverter : JsonConverter {
		...
		public override object ReadJson (Type objectType, Dictionary<string, object> values) {
			...
			if (arr.Length != 16) {
				EB.Debug.LogError("Number of elements in matrix was not 16 (got {0})", arr.Length);
				return m;
			}
