...
{
    public class UltimateTrialCompeteCurRankController : CommonRankPageController<LTUltimateTrialCompeteRankItemData>
    {
        ...
        {
            m_PageDataPath = "rank.personal.speedinifiniteChallenge";
