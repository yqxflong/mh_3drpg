...
{
    public class FloatingUITextManager : DynamicMonoHotfix
    {
        public FloatingUIManager m_FloatingManager;
        ...
        private static FloatingUITextManager m_instance;
        public static FloatingUITextManager Instance
        {
            get
            {
                if (null == m_instance)
